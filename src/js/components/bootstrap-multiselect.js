...
(function($) {
    ...
    Multiselect.prototype = {
        ...
        buildDropdownOptions: function() {
            ...
            // update width of ul by children
            // add by xiufu.yuan
            var num = this.$select.children().length;

            if (num <= 10) {
                this.$ul.css('width', '160px').find('li').css('width', '100%');
            } else if (num <= 20) {
                this.$ul.css('width', '320px').find('li').css('width', '50%');
            } else {
                this.$ul.css('width', '480px').find('li').css('width', '33.33%');
            }
        },
